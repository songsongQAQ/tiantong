...
var Factory = /** @class */ (function () {
    ...
    Factory.prototype.initControllersByImports = function (imports) {
        ...
        imports.forEach(function (Controller) {
            var mateControllers = Reflect.getMetadata('controllers', Controller);
            // 递归模块下的controller
            if (mateControllers === null || mateControllers === void 0 ? void 0 : mateControllers.length) {
                Controllers = __spreadArray(__spreadArray([], Controllers, true), mateControllers, true);
            }
            // 递归模块下的imports
            Controllers = __spreadArray(__spreadArray([], Controllers, true), _this_1.initControllersByImports(Reflect.getMetadata('imports', Controller) || []), true);
        });
        return Controllers;
    };
    Factory.prototype.initRoute = function (Controllers) {
        ...
        Controllers.forEach(function (Controller) {
            ...
            var args = paramtypes.map(function (Type) {
                ...
                return _this_1.types[Type.name]
                    ? _this_1.types[Type.name]
                    : (_this_1.types[Type.name] = new Type());
            });
            // 获取当前控制器的基础路径
            ...
            fetch: function (req) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, _this.handleRoute(req)];
